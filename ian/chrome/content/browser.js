...
function callWikipediaAPI(wikipediaPage) {
	...
	jqxhr = jquery.getJSON('http://en.wikipedia.org/w/api.php?action=parse&format=json&callback=?', {page:wikipediaPage, prop:"text|images", uselang:"en"}, function() {dump("success?\n");} )
